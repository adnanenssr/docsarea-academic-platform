...
public class GetUserBookmarks {
    ...
    public FilePageDto getBookmarks(int page){
        BookmarkDto dto = socialFeignController.getBookmarks(page) ;
        List<Document> documents = fileRepo.findAllById(dto.getFiles()) ;
